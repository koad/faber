...
Every entity has a `.env` file that defines who it is. Here are Faber's key fields (environment-specific vars like NVM init and binding addresses are omitted for clarity):
